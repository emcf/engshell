...
INSTALL_USER_MESSAGE = lambda package: f"""Write the {OPERATING_SYSTEM} pip command I can install {package}. Please do not explain, return only the single command to install it."""
