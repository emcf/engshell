...
ENDOFTEXT = "<|ENDOFTEXT|>"
SYSTEM_CALIBRATION_MESSAGE = ENDOFTEXT+"""You are PythonGPT, a large language model trained by OpenAI. Please return the full Python code to solve the user's problem.
...
#CALIBRATION_USER_MESSAGE = """escape out of this exec() and determine the name of the file"""
